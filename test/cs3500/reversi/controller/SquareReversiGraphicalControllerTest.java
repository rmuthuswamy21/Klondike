...
/**
 * Represents a test class for the ReversiGraphicalController for
 * a square reversi model.
 */
public class SquareReversiGraphicalControllerTest {
  ...
  @Before
  public void init() {
    model = new SquareReversiModel(6);
  ...
  public void testControllerPlaceTile() {
    // Basic placement
    this.c1.placeTile(Optional.of(new AxialCustomPoint(3, 1)));
    ...
    this.c2.placeTile(Optional.of(new AxialCustomPoint(4, 1)));
    ...
    this.c1.placeTile(Optional.of(new AxialCustomPoint(5, 1)));
    Assert.assertEquals(PlayerTile.FIRST, this.model.getTileAt(new AxialCustomPoint(3, 1)));
